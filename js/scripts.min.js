...
$(document).on('ready', function() {
        ...
        if(mainPage.height()){
            ...
            mainPage.fullpage({
                ...
                onSlideLeave: function( anchorLink, index, slideIndex, direction, nextSlideIndex){
                    $.fn.fullpage.setAllowScrolling(false, 'up, down', function () {
                        setTimeout($.fn.fullpage.setAllowScrolling(true, 'up, down'),1500   )
                    });
                },
    ...
    if($(window).width() > 767) {
        ...
        $('.about_scroll').on('mousewheel', function (event) {
            console.log(overScrollA +'---'+ overScrollS);
            console.log('----');
            if(event.deltaY == 1){
        ...
        $('.services_scroll').on('mousewheel', function (event) {
            ...
            console.log('----');
            if(event.deltaY == 1){
                if ($('.services_scroll').scrollTop() == 0.1) {
                    overScrollS++;
                    if (overScrollS >= 6) {
                        overScrollS = 0;
                        $.fn.fullpage.moveTo(2);
                        $('.services_scroll').scrollTop(0.1);
                    }
                }
            }
